...
class bookMarker {
            ...
            this.bookmarks =
                [
                    ...
                    },
                    {
                        ...
                        title: "https://classes.lanecc.edu"
                    }
                ];
    ...
    fillBookmarksList() {
        ...
        /* Added to Save Tasks in Local Storage*/
    ...
    generateBookHtml(bookmark, index) {
        ...
        output = `
            <li class="item-${index}">
               ...
               <span class="item-link"><a href="${bookmark.link}">${bookmark.link}</a>
               <span class="item-description"><p>${bookmark.description}</p></span>
            </li>
        `;
        return output;
    }
